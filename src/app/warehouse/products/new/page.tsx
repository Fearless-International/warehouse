    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              required
            />
            <p className="text-xs text-gray-500 mt-1">Starting stock quantity</p>
          </div>
        ...
        <div>
          ...
          />
          <p className="text-xs text-gray-500 mt-1">Company or person supplying this product</p>
        </div>
